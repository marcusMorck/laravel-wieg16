...
class KlarnaController extends Controller
{
    public function index(){
        ...
        $merchantUrls = [
            'terms' =>  'http://terms',
            'checkout' =>  'http://larwieg.dev/klarna?klarna_order_id={checkout.order.id}',
            'confirmation' =>  'http://larwieg.dev/klarna?klarna_order_id={checkout.order.id}',
        ...
        {
            $merchantUrls = [
                'terms' => 'http://larwieg.dev',
                'checkout' => 'http://larwieg.dev/klarna?klarna_order_id={checkout.order.id}',
                'confirmation' => 'http://larwieg.dev/klarna-confirmation?klarna_order_id={checkout.order.id}',
                'push' => 'http://larwieg.dev/klarna-push?klarna_order_id={checkout.order.id}'
            ];
